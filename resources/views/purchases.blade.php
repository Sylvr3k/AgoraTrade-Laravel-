    ...
    <div class="main">
        <div class="topbar">
            <div>
                ...
                <div class="topbar-sub">{{ $purchases->count() }} item{{ $purchases->count() !== 1 ? 's' : '' }} bought
                </div>
            </div>
                    ...
                    <table class="purchases-table">
                        ...
                        <tbody>
                            @foreach($purchases as $purchase)
                                <tr>
                                    <td style="color:#999; font-size:12px;">#{{ str_pad($purchase->id, 4, '0', STR_PAD_LEFT) }}
                                    </td>
                                    ...
                                    <td><strong>KES {{ number_format($purchase->price, 2) }}</strong></td>
                                    <td style="color:#999; font-size:12px;">{{ $purchase->created_at->format('M j, Y') }}</td>
                                    <td>
                                        <span
                                            class="badge badge-{{ strtolower($purchase->status) }}">{{ $purchase->status }}</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
