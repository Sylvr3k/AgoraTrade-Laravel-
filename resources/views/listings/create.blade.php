                        ...
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title') }}"
                                    placeholder="e.g. Sony PlayStation 5 Pro 2TB — Like New" required>
                            </div>

                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea id="description" name="description"
                                    placeholder="Describe your item — condition, what's included, any flaws..."
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="category" name="category" required>
                                        ...
                                        <option value="Antiques" {{ old('category') === 'Antiques' ? 'selected' : '' }}>
                                            Antiques</option>
                                        ...
                                        <option value="Clothing" {{ old('category') === 'Clothing' ? 'selected' : '' }}>
                                            Clothing</option>
                                        <option value="Computers/Tablets & Networking" {{ old('category') === 'Computers/Tablets & Networking' ? 'selected' : '' }}>
                                ...
                                <div class="condition-grid">
                                    @foreach(['Brand New', 'Like New', 'Very Good', 'Good', 'Acceptable', 'For Parts'] as $condition)
                                        <div class="condition-option">
                                            <input type="radio" name="condition" id="cond_{{ $loop->index }}"
                                                value="{{ $condition }}" {{ old('condition') === $condition ? 'checked' : '' }}>
