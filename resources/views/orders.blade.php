...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Roboto', sans-serif; }
        ...
        .orders-table th { font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px; color: #999; padding: 12px 16px; text-align: left; border-bottom: 1px solid #f0f0f0; background: #fafafa; }
        .orders-table td { padding: 14px 16px; font-size: 13px; color: #333; border-bottom: 1px solid #f5f5f5; vertical-align: middle; }
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-sub">{{ $orders->count() }} order{{ $orders->count() !== 1 ? 's' : '' }} received</div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <table class="orders-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="color:#999; font-size:12px;">#{{ str_pad($order->id, 4, '0', STR_PAD_LEFT) }}</td>
                        <td>
