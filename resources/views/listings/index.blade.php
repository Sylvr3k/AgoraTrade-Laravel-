    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Roboto', sans-serif; }
        ...
        .alert-success {
            ...
            border-radius: 15px 0 15px 0; padding: 12px 16px;
            margin-bottom: 20px; font-size: 13px; color: #3B6D11;
        }
        ...
        .filter-bar input:focus { border-color: #ffe0a9; }
        .filter-btn {
            padding: 9px 16px; border: 1px solid #ddd;
        ...
        .filter-btn.gold { background: #ffe0a9; color: #555; border-color: #ffe0a9; }
        ...
        .listing-card {
            background: #fff; border-radius: 15px 0 15px 0;
        ...
        .listing-price { font-size: 16px; font-weight: bold; color: #333; }
        .listing-condition { font-size: 11px; color: #999; }
        ...
        .badge-sold    { background: #E6F1FB; color: #185FA5; }
        ...
        .btn-edit:hover { border-color: #333; color: #333; }
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-sub">{{ $listings->count() }} item{{ $listings->count() !== 1 ? 's' : '' }} listed</div>
        </div>
    ...
    <div class="content">
        ...
        @else
            ...
            <div class="listings-grid" id="listingsGrid">
                ...
                <div class="listing-card" data-status="{{ $listing->status }}" data-title="{{ strtolower($listing->title) }}">
                    @if($listing->image)
                    ...
                    <div class="listing-body">
                        ...
                        <div class="listing-footer">
                            ...
                            <div class="action-btns">
                                <form method="POST" action="{{ url('/listings/' . $listing->id) }}" onsubmit="return confirm('Delete this listing?')">
                                    @csrf
                                    @method('DELETE')
