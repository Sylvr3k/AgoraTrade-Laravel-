...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Administrator\AgoraToo\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Administrator\\AgoraToo\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'login','profile','profile.update',
'login.post','signup.form','signup.store','logout','storage.local',);
        registerArgumentsSet('views', 
'login','profile','signup','welcome','laravel-exceptions-renderer::components.card',
